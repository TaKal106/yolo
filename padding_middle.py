...
# 结果保存的文件夹路径
save_folder = 'runs_light/padding_middle_result/'

# 保留的上部分高度百分比和下部分高度百分比
top_percent = 0.30 #上部分隐藏%多少高度
bottom_percent = 0.39 #下部分隐藏%多少高度
# middle_percent = 0.33 #中间部分隐藏%多少高度
...
for png_file in png_files:
    ...
    # # 将中间区域涂成黑色
    # img[top_height:top_height + middle_height, :] = 0
